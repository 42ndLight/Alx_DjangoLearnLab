...
from .views import search_posts, profile_view, register, user_login, user_logout, ListPostView, DetailPostView, CreatePostView, UpdatePostView, DeletePostView, CommentCreateView, CommentDeleteView, CommentUpdateView, CommentListView, PostByTagListView
...
urlpatterns = [
    ...
    path('tags/<str:tag_name>/', PostByTagListView.as_view() , name='tag_posts'),
]