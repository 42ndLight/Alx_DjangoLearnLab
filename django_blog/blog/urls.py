...
from .views import profile_view, register, user_login, user_logout, ListPostView, DetailPostView, CreatePostView, UpdatePostView, DeletePostView, CommentCreateView, CommentDeleteView, CommentUpdateView, CommentListView
